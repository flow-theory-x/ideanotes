...
```bash
# 本番用ディレクトリ作成
sudo mkdir -p /home/{username}/production

# 開発版から本番用にクローン（またはコピー）
cd /home/{username}/production
git clone /home/{username}/develop/myapp myapp
# または: sudo cp -r /home/{username}/develop/myapp /home/{username}/production/

# DocumentRootをシンボリックリンクに
sudo rm -rf /var/www/html/myapp.example.com
sudo ln -s /home/{username}/production/myapp /var/www/html/myapp.example.com

# 権限調整
sudo chown -R {username}:apache /home/{username}/production/myapp
sudo chmod -R 755 /home/{username}/production/myapp
```
...
```bash
# 開発版から本番へコピー
sudo cp -r /home/{username}/develop/myapp/* /var/www/html/myapp.example.com/
